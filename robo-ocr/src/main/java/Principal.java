...
public class Principal {
	...
	private static final String USER_HOME = System.getProperty("user.home").concat(File.separator).concat("evidencias")
	...
	public static void main(String[] args) {
		...
		JOptionPane.showMessageDialog(quadroBranco,
				"Resultado: " + (resultadoTeste ? "Sucesso" : "Falha - " + etapa) + ". Evidencias: " + USER_HOME);
		quadroBranco.setVisible(false);
		System.exit(0);
	}

	public static void highlightWithPrintScreen(Region regiao, String fileName)
